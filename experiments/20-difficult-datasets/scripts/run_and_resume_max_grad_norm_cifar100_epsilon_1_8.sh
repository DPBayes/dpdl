#!/bin/bash
##################################################
### Experiment: Difficult Datasets
##################################################
#
set -euo pipefail

# Base configurations
EXPERIMENT_BASE="20-difficult-datasets"
LOG_DIR="/projappl/$PROJECT/dpdl/experiments/$EXPERIMENT_BASE/data_cifar100_epsilon_1_8"
mkdir -p $LOG_DIR
...
EPOCHS=40
#LEARNING_RATES="1e-4 0.000316 0.001 0.00316 0.01 0.0316 0.05"
#BATCH_SIZES="256 512 1024 2048 4096 8196 -1"
MAX_GRAD_NORMS="0.01 0.1 1 3.5 12.25 42.96 150.0"
#EPSILONS="0.25 0.5 1 2 4 8"
EPSILONS="1 8"
OPTUNA_CONFIG="conf/optuna_hypers-difficult-datasets.conf"
        ...
        do
            ...
            do
                ...
                do
                    ...
                    EXPERIMENT_NAME="${model}_${clean_dataset_name}_Subset${subset_size}_Epsilon${rounded_epsilon}_MaxGradNorm${max_grad_norm}_Seed${seed}"
