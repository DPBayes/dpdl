...
#CLIPPING_BOUNDS="0.01 0.1 1 3.5 12.25 42.96 150.0"
EPSILONS="1 8"
        ...
        do
            ...
            do
                ...
                do
                    ...
                    EXPERIMENT_NAME="${model}_${clean_dataset_name}_Subset${subset_size}_Epsilon${rounded_epsilon}_BatchSize${batch_size}_Seed${seed}"
