...
LOG_DIR="/projappl/$PROJECT/dpdl/experiments/$EXPERIMENT_BASE/data_optimize_all"
mkdir -p $LOG_DIR
    ...
    do
        ...
        do
            ...
            do
                ...
                EXPERIMENT_NAME="${model}_${clean_dataset_name}_Subset${subset_size}_Epsilon${rounded_epsilon}_ALL_Seed${seed}"
