    ...
    do
        ...
        do
            ...
            do
                ...
                do
                    EXPERIMENT_NAME="${model}_${clean_dataset_name}_Subset${subset_size}_Epsilon${rounded_epsilon}_MaxGradNorm${max_grad_norm}_ImbalanceClass${IMBALANCE_CLASS}_ImbalanceFactor${imbalance_factor}"
                    ...
                    sbatch -J $EXPERIMENT_NAME run8.sh run.py optimize \
                        ...
                        --fairness-imbalance-class $IMBALANCE_CLASS
