#!/bin/bash
############################################################
### Experiment: Hyperparameter grid (10% of balanced SVHN)
############################################################

set -euo pipefail

# Base configurations
EXPERIMENT_BASE="21-hyperparameter-grid-with-gradient-recording"
LOG_DIR="/projappl/$PROJECT/dpdl/experiments/$EXPERIMENT_BASE/data_svhn_epsilon8"
mkdir -p $LOG_DIR
...
EPOCHS=40
LEARNING_RATES="0.0005 0.0010150474496062433 0.002060642649904278 0.004183300132670377 0.008492496261209053 0.017240573341461615 0.035"
BATCH_SIZES="192 512 1024 2048 4096 -1"
MAX_GRAD_NORMS="0.001 0.004966097133897474 0.0246621207433047 0.12247448713915891 0.6082201995573401 3.0204805898002562 15.0"
#EPSILONS="1 8"
EPSILONS="8"
SEEDS="42"
