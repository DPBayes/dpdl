#!/bin/bash
####################################################################
### Experiment: Pretrained vs from scratch (batch size sweep)
####################################################################
#
set -euo pipefail
...
PEFT=""
RECORD_GRADIENT_NORMS="--record-gradient-norms"
        ...
        do
            ...
            do
    		    ...
    		    for training_mode in "${TRAINING_MODES[@]}"
    		        ...
    		        EXPERIMENT_NAME="${model}_${clean_dataset_name}_Subset${subset_size}_Epsilon${rounded_epsilon}_BatchSize${batch_size}_${EXPERIMENT_SUFFIX}_Seed${seed}"
