#!/bin/bash
##################################################################
### Experiment: Hyperparameters as a function of number of classes
##################################################################

set -euo pipefail

EXPERIMENT_BASE="27-hypers-vs-number-of-classes"
...
DATASETS=(
   "dpdl-benchmark/imagenet-mini-64"
   "dpdl-benchmark/imagenet-mini-128"
   "dpdl-benchmark/imagenet-mini-256"
   "dpdl-benchmark/imagenet-mini-512"
)
EPOCHS=40
EPSILONS="1 2 4 8"
OPTUNA_CONFIG="conf/optuna_hypers-hypers-vs-number-of-classes.conf"

declare -A DATASET_LABEL_FIELDS=(
    ["dpdl-benchmark/imagenet-mini-64"]="label"
    ["dpdl-benchmark/imagenet-mini-128"]="label"
    ["dpdl-benchmark/imagenet-mini-256"]="label"
    ["dpdl-benchmark/imagenet-mini-512"]="label"
)

declare -A SUBSET_SIZES=(
    ["dpdl-benchmark/imagenet-mini-64"]="1.0"
    ["dpdl-benchmark/imagenet-mini-128"]="1.0"
    ["dpdl-benchmark/imagenet-mini-256"]="1.0"
    ["dpdl-benchmark/imagenet-mini-512"]="1.0"
)
