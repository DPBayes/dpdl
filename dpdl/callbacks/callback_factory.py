...
from .record_learning_rate import RecordLearningRateByEpochCallback
...
class CallbackFactory:
    ...
    def get_callbacks(
        ...
        if configuration.record_learning_rate:
            callbacks.append(RecordLearningRateByEpochCallback(log_dir=full_log_dir))
